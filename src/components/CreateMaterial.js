...
function AddMaterial(props) {
  ...
  const handleMaterialSubmit = async (e) => {
    e.preventDefault()
    const requestBody = { name, ref, owner, category, description, picture, condition, ageMin, ageMax }
    try {
      ...
      <div>
        <form onSubmit={handleMaterialSubmit}>
          ...
          <div>
            ...
            <input type="text" name="ref" id="ref" value={ref} onChange={handleRef} />
          </div>
          <div>
            <label htmlFor="owner">Association Propriétaire</label>
            <input type="text" name="owner" id="owner" value={owner} onChange={handleOwner} />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="file" name="picture" id="picture" value={picture} onChange={handleFileUpload} />
          </div>
          <div>
            <label htmlFor="condition">Etat</label>
            <input type="text" name="condition" id="condition" value={condition} onChange={handleCondition} />
          </div>
          <div>
            <label htmlFor="ageMin">Age Minimum</label>
            <input type="text" name="ageMin" id="ageMin" value={ageMin} onChange={handleAgeMin} />
          </div>
          <div>
            <label htmlFor="ageMax">Age Maximum</label>
            <input type="text" name="ageMax" id="ageMax" value={ageMax} onChange={handleAgeMax} />
          </div>
          <div>
